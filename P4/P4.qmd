...
msa_blocks <- blocks(state = "NY",
                     county = kingston_counties_3_digit,
                     progress_bar = FALSE)
...
Is the number of rows in zones in trip generation table squared the same as and number of rows in your skim?

If not there are zones missing from your skim.
...
skim <- travel_time_matrix(kingston_core,
