...
# Create the histogram and store it as an object
hist_plot <- ggplot(ppl_data) +
  geom_histogram(aes(x = chaffeured_trips),
                 binwidth = 1,
                 color = "gray",
                 fill = "lightgreen") +
  scale_x_continuous(name = "Number of chauffeured trips",
                     breaks = seq(0, 12, by=1)) +
  scale_y_continuous(name = "Number of people in NHTS Sample") +
  theme_minimal()

# Save the plot as a PNG file
ggsave("chaffeured_trips_histogram.png", plot = hist_plot, width = 8, height = 6, dpi = 300)
